...
| 프로젝트 | 기술 스택 | 설명 | 상태 |
|---------|----------|------|------|
| [PF-IaC — Terraform + Ansible 연동](PortFolio/PF-IaC/) | `Terraform` `Ansible` `AWS` | Terraform 스택 위에 Ansible로 서버 초기설정(Docker·nginx)·앱 배포 자동화 · [Ansible 기초 실습·정리집 →](ansible/) | 🔄 진행 중 |
